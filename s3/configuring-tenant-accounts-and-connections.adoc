...
* Das ist schon link:../admin/creating-tenant-account.html["S3-Mandantenkonto wurde erstellt"].
* Sie haben sich beim Mieter und angemeldet link:../tenant/creating-your-own-s3-access-keys.html["Zugriffsschlüssel erstellt"].
...
.. Geben Sie die Standardregion ein, die verwendet werden soll. Beispiel: `us-east-1`.
