...
11.8
 a| 
Die Namen von S3-Vorgängen wurden entsprechend den in der verwendeten Namen aktualisiert http://docs.aws.amazon.com/AmazonS3/latest/API/Welcome.html["Amazon Web Services (AWS) Dokumentation: Amazon Simple Storage Service API Reference"^].
