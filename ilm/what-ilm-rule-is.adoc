...
Die zweite Platzierungsanweisung image:../media/icon_number_2.png["Symbol Nummer 1"] Erstellt zwei Kopien nach einem Jahr und speichert diese Kopien für immer.
