...
Objektsperre Aktiviert
 a| 
Der Wert der Anfrageüberschrift `x-amz-bucket-object-lock-enabled`, Wenn in der Anfrage vorhanden.
...
Gesetzliche Sperren Für Objekte
 a| 
Der Wert der Anfrageüberschrift `x-amz-object-lock-legal-hold`, Wenn in der PutObject-Anfrage vorhanden.
...
Aufbewahrungsmodus Für Objektsperre
 a| 
Der Wert der Anfrageüberschrift `x-amz-object-lock-mode`, Wenn in der PutObject-Anfrage vorhanden.
...
Objektsperre Bis Datum Beibehalten
 a| 
Der Wert der Anfrageüberschrift `x-amz-object-lock-retain-until-date`, Wenn in der PutObject-Anfrage vorhanden.
