...
.Bevor Sie beginnen
* Sie haben den Swift-Befehlszeilenclient heruntergeladen und installiert: https://docs.openstack.org/python-swiftclient/latest/["SwiftStack: python-wiftclient"^]
