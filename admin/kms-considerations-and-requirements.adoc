...
Als bewährte Sicherheitsverfahren sollten Sie regelmäßig Verfahren link:kms-managing.html#rotate-key["Drehen Sie den Verschlüsselungsschlüssel"] Wird von jedem konfigurierten KMS verwendet.
