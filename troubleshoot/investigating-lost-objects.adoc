...
summary: Wenn die Meldung „Objekte verloren“ ausgelöst wird, müssen Sie unverzüglich eine Untersuchung durchführen. Sammeln Sie Informationen zu den betroffenen Objekten und wenden Sie sich an den technischen Support. 
---
